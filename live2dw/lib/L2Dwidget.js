        ...
        (function (t) {
                        ...
                        if (1 == t.length) {
                            ...
                            for (l = 0; l < t.length; l++) {
                                ...
                                if (o == l) this.setPartsOpacity(p, n);
                                    ...
                                    (1 - (h = n < 0.5 ? (-0.5 * n) / 0.5 + 1 : (0.5 * (1 - n)) / 0.5)) * (1 - n) > 0.15 && (h = 1 - 0.15 / (1 - n)), $ > h && ($ = h), this.setPartsOpacity(p, $);
                                }
                            }
                        }
                    else
                    ...
                    for (var r = 0, n = 0; n < o.CHANNEL_COUNT; n++) {
                        ...
                        if (0 == s);
                            ...
                            for (var a = 0; a < s; a++) {
                                var h = 0;
                                $ = ~~($ = a % 2);
                                ((l = this.clipContextList[r++]).layoutChannelNo = n), (l.layoutBounds.x = 0.5 * $), (l.layoutBounds.y = 0), (l.layoutBounds.width = 0.5), (l.layoutBounds.height = 1);
                            }
                        else if (s <= 4)
                            for (a = 0; a < s; a++) {
                                ($ = ~~($ = a % 2)), (h = ~~(h = a / 2));
                                ((l = this.clipContextList[r++]).layoutChannelNo = n), (l.layoutBounds.x = 0.5 * $), (l.layoutBounds.y = 0.5 * h), (l.layoutBounds.width = 0.5), (l.layoutBounds.height = 0.5);
                            }
                        else if (s <= 9)
                            for (a = 0; a < s; a++) {
                                var $;
            ...
            T._$ni = function (t, i, e, r, o, n, s, _, a) {
                ...
                return (
                    ...
                    isNaN($) && (($ = (t - e - l * s) / o), isNaN($) && ($ = (i - r - l * _) / n), isNaN($) && (console.log("a is NaN @UtVector#_$ni() "), console.log("v1x : " + o), console.log("v1x != 0 ? " + (0 != o)))),
            ...
            (S._$Z2 = function (t, i, e, r) {
                ...
                if (4 == o) {
                    ...
                    return (
                        ((S = ((_ = ((p = (v + (L - v) * l) | 0) + ((c = (M + (E - M) * l) | 0) - p) * u) | 0) + ((a = ((f = (A + (I - A) * l) | 0) + ((g = (x + (w - x) * l) | 0) - f) * u) | 0) - _) * P) | 0) +
                            ((((h = ((y = (D + (O - D) * l) | 0) + ((d = (R + (b - R) * l) | 0) - y) * u) | 0) + (($ = ((m = (F + (C - F) * l) | 0) + ((T = (N + (B - N) * l) | 0) - m) * u) | 0) - h) * P) | 0) - S) * G) |
                        0
                    );
                }
                ...
                (S._$br = function (t, i, e, r) {
                    ...
                    if (4 == o) {
                        var P = r[n[0]],
                            ...
                            B = s[3];
                        return (
                            (1 - B) * ((1 - N) * ((1 - T) * (P + (S - P) * l) + T * (v + (L - v) * l)) + N * ((1 - T) * (M + (E - M) * l) + T * (A + (I - A) * l))) +
                            B * ((1 - N) * ((1 - T) * (x + (w - x) * l) + T * (D + (O - D) * l)) + N * ((1 - T) * (R + (b - R) * l) + T * (F + (C - F) * l)))
                        );
                    }
                    ...
                    if (a <= 0) {
                        ...
                        for (c = 0; c < l; )
                            (n[u] = ht * X[c] + $t * z[c] + lt * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * it[c] + Pt * et[c] + St * rt[c] + vt * ot[c] + Lt * nt[c]),
                                ++c,
                                (n[u + 1] =
                                    ht * X[c] + $t * z[c] + lt * H[c] + ut * W[c] + pt * j[c] + ct * q[c] + ft * J[c] + gt * Q[c] + yt * Z[c] + dt * K[c] + mt * tt[c] + Tt * it[c] + Pt * et[c] + St * rt[c] + vt * ot[c] + Lt * nt[c]),
                                ++c,
                                (u += _);
                    } else {
            ...
            function B() {}
            (B._$Ms = 1), (B._$Qs = 2), (B._$i2 = 0), (B._$No = 2), (B._$do = B._$Ms), (B._$Ls = !0), (B._$1r = 5), (B._$Qb = 65), (B._$J = 1e-4), (B._$FT = 0.001), (B._$Ss = 3);
            function G() {}
            (G._$o7 = 6),
                (G._$S7 = 7),
                (G._$s7 = 8),
                        ...
                        if (((v = i[T]), (S = (L = i[T + 1]) * a), (P = v * _) < 0 || S < 0 || _ <= P || a <= S)) {
                            ...
                            if (!m) {
                                (m = !0),
                                    ...
                                    (c = 0.25 * (s[2 * (0 + 0 * M) + 1] + s[2 * (_ + 0 * M) + 1] + s[2 * (0 + a * M) + 1] + s[2 * (_ + a * M) + 1]));
                                var E = s[2 * (_ + a * M)] - s[2 * (0 + 0 * M)],
                                    A = s[2 * (_ + a * M) + 1] - s[2 * (0 + 0 * M) + 1],
                                    I = s[2 * (_ + 0 * M)] - s[2 * (0 + a * M)],
                                    x = s[2 * (_ + 0 * M) + 1] - s[2 * (0 + a * M) + 1];
                                (p -= 0.5 * ((f = 0.5 * (E + I)) + (y = 0.5 * (E - I)))), (c -= 0.5 * ((g = 0.5 * (A + x)) + (d = 0.5 * (A - x))));
                            }
                            if (-2 < v && v < 3 && -2 < L && L < 3)
                                if (v <= 0)
                                    if (L <= 0) {
                                        ...
                                        (B = 0.5 * (v - -2)) + (G = 0.5 * (L - -2)) <= 1
                                            ...
                                            : ((e[T] = w + (O - w) * (1 - B) + (b - w) * (1 - G)), (e[T + 1] = D + (R - D) * (1 - B) + (F - D) * (1 - G)));
                                    } else if (L >= 1) {
                            ...
                            (h = 2 * ((0 | P) + (0 | S) * (_ + 1))),
                                ($ = P - (0 | P)) + (l = S - (0 | S)) < 1
                                    ? ((e[T] = s[h] * (1 - $ - l) + s[h + 2] * $ + s[h + 2 * (_ + 1)] * l), (e[T + 1] = s[h + 1] * (1 - $ - l) + s[h + 3] * $ + s[h + 2 * (_ + 1) + 1] * l))
                    ...
                    for (var _, a, h, $, l, u, p, c = i, f = this._$o, g = this._$A, y = o * s, d = null != c._$hr ? c._$hr : c._$Cr, m = n; m < y; m += s)
                        _t._$ts
                            ? ((_ = e[m]),
                              ...
                              (p = a - $),
                              (l = 2 * (h + $ * (f + 1))))
                            : ((u = (_ = e[m] * f) - (0 | _)), (p = (a = e[m + 1] * g) - (0 | a)), (l = 2 * ((0 | _) + (0 | a) * (f + 1)))),
                            u + p < 1
                                ? ((r[m] = d[l] * (1 - u - p) + d[l + 2] * u + d[l + 2 * (f + 1)] * p), (r[m + 1] = d[l + 1] * (1 - u - p) + d[l + 3] * u + d[l + 2 * (f + 1) + 1] * p))
            ...
            (_t._$2s = "2.1.00_1"),
                ...
                (_t.DEBUG_DATA = {}),
                (_t.PROFILE_IOS_SPEED = { PROFILE_NAME: "iOS Speed", USE_ADJUST_TRANSLATION: !0, USE_CACHED_POLYGON_IMAGE: !0, EXPAND_W: 4 }),
                (_t.PROFILE_IOS_QUALITY = { PROFILE_NAME: "iOS HiQ", USE_ADJUST_TRANSLATION: !0, USE_CACHED_POLYGON_IMAGE: !1, EXPAND_W: 2 }),
                (_t.PROFILE_IOS_DEFAULT = _t.PROFILE_IOS_QUALITY),
                (_t.PROFILE_ANDROID = { PROFILE_NAME: "Android", USE_ADJUST_TRANSLATION: !1, USE_CACHED_POLYGON_IMAGE: !1, EXPAND_W: 2 }),
                (_t.PROFILE_DESKTOP = { PROFILE_NAME: "Desktop", USE_ADJUST_TRANSLATION: !1, USE_CACHED_POLYGON_IMAGE: !1, EXPAND_W: 2 }),
            ...
            (pt.prototype = new r()),
                ...
                (pt._$er = function (t) {
                    ...
                    if (0 == i.exists()) throw new _$ls("_$t0 _$_ _$6 _$Ui :: " + i._$PL());
                    for (
                        var e = ["../_$_r/_$t0/_$Ri/_$_P.512/_$CP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$vP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$EP._$1", "../_$_r/_$t0/_$Ri/_$_P.512/_$pP._$1"], r = pt.loadModel(i._$3b()), o = 0;
                        o < e.length;
                        o++
                    ) {
                        var n = new _$5(e[o]);
        ...
        (o.prototype.getModelMatrix = function () {
            ...
            (o.prototype.loadModelData = function (t, i) {
                ...
                e.loadLive2DModel(t, function (t) {
                    ...
                    0 == r.Live2D.getError()
                        ? ((o.modelMatrix = new l(o.live2DModel.getCanvasWidth(), o.live2DModel.getCanvasHeight())), o.modelMatrix.setWidth(2), o.modelMatrix.setCenterPosition(0, 0), i(o.live2DModel))
                ...
                for (n = 0; n < i.length; n++) {
                    if (!((s = i[n].partsIndex) < 0))
                        if (r == n) t.setPartsOpacity(s, o);
                            ...
                            (1 - (a = o < 0.5 ? (-0.5 * o) / 0.5 + 1 : (0.5 * (1 - o)) / 0.5)) * (1 - o) > 0.15 && (a = 1 - 0.15 / (1 - o)), h > a && (h = a), t.setPartsOpacity(s, h);
                        }
                }
            }),
            ...
            (_.prototype.tapEvent = function (t, i) {
                ...
                for (var e = 0; e < this.models.length; e++)
                    this.models[e].hitTest(s.cDefine.HIT_AREA_HEAD, t, i)
                        ? (s.cDefine.DEBUG_LOG && console.log("Tap face."), this.models[e].setRandomExpression())
                        : this.models[e].hitTest(s.cDefine.HIT_AREA_BODY, t, i) &&
                          (s.cDefine.DEBUG_LOG && console.log("Tap body. models[" + e + "]"), this.models[e].startRandomMotion(s.cDefine.MOTION_GROUP_TAP_BODY, s.cDefine.PRIORITY_NORMAL));
                return !0;
            }),
            (i.cManager = _);
    },
