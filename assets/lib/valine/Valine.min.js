        ...
        r.prototype.init = function(e) {
            ...
            try {
                var n = e.lang || "",
                    ...
                    o = e.avatar,
                    s = e.avatar_cdn || "";
                n && r && t.installLocale(n, r), t.locale = t.locale || h[e.lang || "zh-cn"], t.notify = e.notify || !1, t.verify = e.verify || !1, v.params = "?d=" + (i.indexOf(o) > -1 ? o : "mp"), v.hide = "hide" === o, v.cdn = !!s && s || v.cdn, b = e.path || b;
                var l = Number(e.pageSize || 10);
                if (e.pageSize = isNaN(l) ? 10 : l < 1 ? 10 : l, a.setOptions({
                ...
                var c = e.app_id || e.appId,
                    ...
                    f = (e.region || "cn").toLowerCase(),
                    m = ["cn", "us"];
                if (f = m.indexOf(f) > -1 ? f : m[0], !c || !u) throw 99;
                ...
                for (var x = d.findAll(document, ".valine-comment-count"), w = 0, k = x.length; w < k; w++) ! function(e, n) {
                    var r = x[e];
                    if (r) {
                ...
                t.alert = {
                    show: function(e) {
                        ...
                        if (n.innerHTML = "" + r + (e && e.type && i), d.on("click", d.find(C, ".vcancel"), function(e) {
                                t.alert.hide()
                            }), d.attr(C, "style", "display:block;"), e && e.type) {
                            var o = d.find(C, ".vsure");
                    ...
                    hide: function() {
                        return d.attr(C, "style", "display:none;"), t
                    }
                }, t.bind(e)
            } catch (e) {
                t.ErrorHandler(e)
        ...
        r.prototype.Q = function(e) {
            ...
            var j = function() {
                ...
                P = function(e) {
					...
					if ("" == f.mail) {
						f.mail = "anonymous@ike.today";
						_.mail.value = "anonymous@ike.today";
					}
					if ("" == f.nick) {
						f.nick = "A Lovely friend";
						_.nick.value = "A Lovely friend";
					}
